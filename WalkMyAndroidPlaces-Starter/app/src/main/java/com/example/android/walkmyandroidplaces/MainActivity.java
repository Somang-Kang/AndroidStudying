...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlacePickerButton= (Button) findViewById(R.id.button_pick);
    ...
    public void onTaskCompleted(final String result) {
        if (mTrackingLocation) {
            ...
            if (androidx.core.app.ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            placeResult.addOnCompleteListener(new OnCompleteListener<PlaceLikelihoodBufferResponse>() {
                @Override
                public void onComplete(@androidx.annotation.NonNull Task<PlaceLikelihoodBufferResponse> task) {
